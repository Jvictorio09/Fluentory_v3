...
class Course(models.Model):
    ...
    preview_video_url = models.URLField(blank=True, null=True, help_text="Optional preview/promo video URL (YouTube, Vimeo, etc.)")
    certificate_template = models.FileField(upload_to='certificate_templates/', null=True, blank=True, help_text="Upload a PDF template for certificates. Use placeholders: {student_name}, {course_name}, {date}, {certificate_id}")
    certificate_field_positions = models.JSONField(null=True, blank=True, help_text="JSON object storing field positions for certificate template: {'student_name': {'x': 100, 'y': 200}, ...}")
