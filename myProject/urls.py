...
urlpatterns = [
    ...
    path('home/', views.v3_landing, name='home'),
    ...
    path('register/verify-email-sent/', views.verify_email_sent_view, name='verify_email_sent'),
    path('register/resend-verification/', views.resend_verification_view, name='resend_verification'),
    ...
    path('dashboard/user-management/', dashboard_views.dashboard_user_management, name='dashboard_user_management'),
